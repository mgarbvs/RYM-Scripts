...
A userscript (Tampermonkey / Violentmonkey / Greasemonkey) that adds a **"Copy album card"** button to any RateYourMusic release page. One click composes a clean PNG — cover art, artist, album title, year, rating, and genre pills — and copies it to your clipboard so you can paste it directly into iMessage (Cmd-V).
